...
<template>
  ...
  <span class="ant-input-group-addon">
    <el-dropdown>
      ...
      <template v-slot:overlay>
        <el-menu @click="findFun.changeFindType">
          <el-menu-item v-for="item in meta.findKindList" :key="item" >{{dicFindKind[item]}}</el-menu-item>
        </el-menu>
      </template>
    </el-dropdown>
  </span>
  ...
  <span :title="meta.title" style="vertical-align: top;">
    ...
    <template v-else>
      <!--非范围查询-->
      <el-date-picker v-if="controlModeKey < 142"
        :show-time="controlModeKey === '141'"
      ...
      <el-month-picker v-else-if="controlModeKey === '143'"
      ...
      <el-week-picker v-else-if="controlModeKey === '144'"
  ...
  <span style="vertical-align: top;">
    <el-dropdown>
      ...
      <template v-slot:overlay>
        <el-menu @click="changeControlMode">
          <el-menu-item key="140">日期</el-menu-item>
          <el-menu-item key="143">年月</el-menu-item>
          <el-menu-item key="144">年周</el-menu-item>
          <el-menu-item key="141">日时</el-menu-item>
        </el-menu>
      </template>
    </el-dropdown>
  </span>
